...
public class TopApiProException {
	...
	private Integer proExcMinCount;
	...
	public Integer getProExcMinCount() {
		return proExcMinCount;
	}

	public void setProExcMinCount(Integer proExcMinCount) {
		this.proExcMinCount = proExcMinCount;
	}
